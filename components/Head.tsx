...
export const Head: FC<Props> = ({
  ogImage = 'https://cdn.discordapp.com/attachments/1084638563188084756/1108381495506239539/22712481_10159693051770093_3548004291470835561_o.jpg',
  title = 'Ikigai Labs XYZ | Open Source NFT Marketplace',
  description = 'Ikigai Labs XYZ is an open source NFT marketplace built with Reservoir.',
}) => {
  return (
    <NextHead>
      ...
      <meta property="og:image:alt" content="Ikigai Labs XYZ Banner" />
    </NextHead>
  )
}
